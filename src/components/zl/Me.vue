...
        <router-link to="/Details">
          <div class="product_app">
            <!--添加一个商品 start-->
            <div class="goods-item" v-for="(item,i) of list" :key="i" @click="details">
            <img :src="item.po_url" alt="">
            <h3>{{item.po_title}}</h3>
            <div class="user">
              <div class="userr">
...
        <router-link to="/Details">
          <div class="product_app">
            <!--添加一个商品 start-->
            <div class="goods-item" v-for="(item,i) of list.data" :key="i" @click="details">
            <h3>{{item.title}}</h3>
            <div class="user">
              <div class="userr">
              </div>
    ...
    if(res.data.code===1){
      ...
      for(var i=0;i<res.data.data.length;i++){
        ...
        if(this.list[i].user_pic==null){
          ...
          console.log(this.list[i].po_url=res.config.baseURL+this.list[i].po_url);
