<template>
  <div class="container">
    ...
    <div id="top">
      ...
      <div class="left">
        <!-- 返回键 -->
          <img src="../../../assets/back.png" class="back" @click="me">
        <!-- 头像 -->
          <img :src="tou" class="photo" >
          <div class="username">
        <!-- 用户名  -->
    ...
    <div id="carousels">    
      <p>
        <mt-swipe :auto="4000">
          <mt-swipe-item><img :src="picUrl" style="width:100%;"></mt-swipe-item>
        </mt-swipe>
      </p>
    </div>
...
        this.downIcon3 = !this.downIcon3
      ...
      loadData(){
        ...
        let poid = location.hash;
        poid = poid.substr(poid.lastIndexOf("=")+1);
        var url="/center/mybook";
        //var uid=$store.getters.getUid;
        var obj={uid:this.uid,pid:poid};
        //console.log(obj);
        this.axios.get(url,{params:obj})
        .then(res=>{//成功回调
        console.log(res.data.gzsl[0].po_title)
  
        console.log(this.tou = res.config.baseURL + 'head/' +res.data.gzsl[0].user_pic);
        console.log(this.picUrl=res.config.baseURL+'title/'+res.data.gzsl[0].po_url);
        this.title = res.data.gzsl[0].po_title;
        // console.log(res.config.baseURL+this.list[0].po_url)
        
        //   console.log(this.list[0].po_url)
          // console.log(res.config.baseURL+"head/"+this.list[0].user_pic);
